# FP8 mixed-precision training with FP32 master weights on CPU-Proxmox-1

Status: `useful_signal`
Curation bucket: `followup_recommended`
Curation score: `83`
Project ID: `fp8-mixed-precision-training-with-fp32-master-weights-on-cpu-proxmox-1-ba6125ed0044`
Run ID: `fp8-mixed-precision-training-with-fp32-master-weights-on-cpu-proxmox-1-ba6125ed0044-20260610T102800436544+0000`
...
- Artifact root: `<local-path>/projects/fp8-mixed-precision-training-with-fp32-master-weights-on-cpu-proxmox-1-ba6125ed0044`
- `run_notes.md`
