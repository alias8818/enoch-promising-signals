# CPU-Only N-Gram Speculative Decoding Cascade on cpu-worker

Status: `useful_signal`
Curation bucket: `followup_recommended`
Curation score: `83`
Project ID: `cpu-only-n-gram-speculative-decoding-cascade-on-cpu-worker-93b47bc6140e`
Run ID: `cpu-only-n-gram-speculative-decoding-cascade-on-cpu-worker-93b47bc6140e-20260629T164012664990+0000`
...
- Artifact root: `<local-path>/projects/cpu-only-n-gram-speculative-decoding-cascade-on-cpu-worker-93b47bc6140e`
- `run_notes.md`
