# Bounded Queue Depth Controller for CPU Worker Proxmox-1

Status: `useful_signal`
Curation bucket: `top_external_researcher_candidates`
Curation score: `98`
Project ID: `bounded-queue-depth-controller-for-cpu-worker-proxmox-1-db71c5f4de42`
Run ID: `bounded-queue-depth-controller-for-cpu-worker-proxmox-1-db71c5f4de42-20260609T212221059442+0000`
...
Evidence is limited to synthetic arrivals and local ProcessPoolExecutor CPU tasks on cpu-proxmox-1. It does not include real Enoch queue traces, production Proxmox scheduling effects, upstream retry behavior, multi-tenant interference, or live controller integration.
...
Run a bounded deepen experiment that replays real Enoch cpu-proxmox-1 arrival/service traces through the same controller and measures p95 latency, throughput, backpressure rate, host load, and retry effects.
...
- Artifact root: `<local-path>/projects/bounded-queue-depth-controller-for-cpu-worker-proxmox-1-db71c5f4de42`
- `run_notes.md`
